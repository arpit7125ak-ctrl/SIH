# SIH 2026 — Software Problem Statements (Point-wise, Original Text)

- **Total:** 172 of 226 problem statements
- **Source:** Smart India Hackathon, sih.gov.in (via community dataset, CC BY 4.0)
- **Note:** Descriptions are split into bullet points exactly as they appear in the source (no lines reworded or merged).

---

## 1. AI-Based early warning and landslide Risk Monitoring System in NER (SIH26001)
...
## 2. Al-Based Smart Logistics and Accessibility Intelligence Platform for North Eastern Region (NER) (SIH26002)
...
## 3. AI-Based Cognitive Gaming and Memory Assistance Platform for Elderly Dementia Patients in North Eastern Region (NER) (SIH26003)
...
## 6. Development of an Intelligent Freight Forecasting Model for Optimized Vessel Chartering and Bulk Cargo Procurement from overseas to East Coast of India (SIH26006)
...
## 9. Using AI/ML and Space Technology to Identify Manganese Reserves and Overcome Production Shortfalls. (SIH26009)
...
## 11. 3D ULPIN Generation and vertical Property Mapping SYstem (SIH26011)
...
## 12. AI-Based Automated Urban Parcel Mapping and Cadastral Feature Extraction System using Drone lmagery (SIH26012)
...
## 13. Automated lntegration and lntelligent Harmonization of Multi-source Geospatial Data for urban Land Record Management. (SIH26013)
...
## 14. An lntegrated GIS-based Digital Public lnfrastructure for Land Governance (SIH26014)
...
## 15. Application of Geospatial Techniques for visualization and analysis to interpret Geo-Coded lmages to enhance watershed Development Outcomes. (SIH26015)
...
## 16. Real-Time National Land Acquisition & Management System for End-to-End Digital Monitoring and Decision Support (SIH26016)
...
## 17. Predictive Analytics System for Early Detection of Land Acquisition Delays (SIH26017)
...
## 18. Intelligent Land Record Digitization and Validation System (SIH26018)
...
## 19. National Digital Platform for Research, Policy Innovation, and Evidence-Based Land Governance (SIH26019)
...
## 21. Honey Chain: A block chain-based system for honey traceability and smart beekeeping management. (SIH26021)
...
## 23. AI-Powered Geological, Mining and other Reporting Solution for CMPDI/CIL subsidiaries (SIH26023)
...
## 24. AI-Based Smart Governance and Compliance Monitoring System for Coal Mines (SIH26024)
...
## 27. Al-Powered Automatic Block Planning to Maximize Asset Availability for Train Operations on Indian Railways (SIH26027)
...
## 28. Dynamic Forecast of Expected Time of Arrival (ETA) for Coaching Trains (SIH26028)
...
## 31. Quality assessment and grading of onions are often subjective and vary across procurement centers, resulting in disputes and inconsistencies. (SIH26031)
...
## 32. Farmers often face long waiting times, lack of information regarding procurement schedules, and uncertainty about procurement status. (SIH26032)
...
## 33. Multiple intermediaries reduce farmers earnings and increase consumer prices. (SIH26033)
...
## 34. Software System to check compliance of Packaged Commodities under Legal Metrology(Packaged Commodities) Rules, 2011 by scanning products, images and labels. (SIH26034)

- **Organization:** Ministry of Consumer Affairs, Food & Public Distribution
- **Theme:** Agriculture, FoodTech & Rural Development
- **Deadline:** 2026-09-20
- **Ideas submitted:** 0/500
- **Dataset link:** https://consumeraffairs.gov.in/pages/legal-metrology-act and the Legal Metrology (Packaged commodities) Rules, 2011
- **Background:**
...
## 35. Development of a Software Program/Application for Generation of Test Reports for Non-Automatic Weighing Instruments (NAWI) as per OIML Recommendation R- 76 (SIH26035)

- **Organization:** Ministry of Consumer Affairs, Food & Public Distribution
- **Theme:** Smart Vehicles
- **Deadline:** 2026-09-20
- **Ideas submitted:** 0/500
- **Dataset link:** https://consumeraffairs.gov.in/pages/legal-metrology-act and the Legal Metrology (General)<br><br> Rules, 2011
- **Background:**
...
## 36. Development of an Online Verification System for Weighing and Measuring Instruments (SIH26036)

- **Organization:** Ministry of Consumer Affairs, Food & Public Distribution
- **Theme:** Transportation & Logistics
- **Deadline:** 2026-09-20
- **Ideas submitted:** 0/500
- **Dataset link:** https://consumeraffairs.gov.in/pages/legal-metrology-act and the Legal Metrology (General) Rules,2011
- **Background:**
...
## 37. Adaptive Path Planning and Collision Avoidance for Autonomous Vehicles on Unstructured Indian Roads (SIH26037)
...
## 38. Explainable AI for Diabetic Retinopathy Screening in Rural India (SIH26038)
...
## 41. AR-Based Vocational Training Simulator for Industrial Safety in Jharkhand's Mining & Manufacturing Sector (SIH26041)
...
## 42. Al-Powered Vernacular Pedagogy and Real-Time Translation Tool for Mother Tongue-Based Primary Education (SIH26042)
...
## 43. A digital platform to crowdsource societal challenges and facilitate collaborative problem solving through universities and industry partnerships (SIH26043)
...
## 44. Portal for Academia - Industry collaboration for Skill Mapping, Internships and Placement (SIH26044)
...
## 45. IP-SAKTI Sahayak a multilingual, RAG-based (source-cited) AI assistant for Intellectual Property and regulatory guidance in Ayurveda, across national and international regimes. (SIH26045)
...
## 46. AIIA Clinical Trials Dashboard - a real-time, cloud-based, GCP-compliant Clinical Trial Management System (CTMS) for Ayurveda research, with CDISC/FHIR-interoperable data, role-based KPIs, and integrated ethics, regulatory (CTRI / NDCT Rules 2019) and pharmacovigilance tracking. (SIH26046)
...
## 47. Patient Case-Taking Software (SIH26047)
...
## 51. Software Based Model Development for Design of Area Specific Shelter for Thermal Comfort Maintenance. (SIH26051)
...
## 53. Adaptive Variable Resolution 2.5D Lidar Mapping for Dynamic Environment Perception (SIH26053)
...
## 54. AI-Enabled Real-Time Digital Twin System for Health Monitoring, Fault Prediction and Mission Reliability Enhancement of Aero Piston Engines used in MALE UAVs. (SIH26054)
...
## 55. Smart Scan strategy for Electronic Warfare (SIH26055)
...
## 56. Development of a Real-time Airfare Price Index for India through Automated Web Scraping of Airline and Online Travel Aggregator Portals for Augmentation of the Consumer Price Index (CPI). (SIH26056)

- **Organization:** MoSPI
- **Theme:** Travel & Tourism
- **Deadline:** 2026-09-20
- **Ideas submitted:** 0/500
- **Dataset link:** https://esankhyiki.mospi.gov.in
...
## 57. AI-Powered Automated Underwater Marine Debris and Anomaly Detection System using Side-Scan Sonar Imagery (SIH26057)
...
## 59. AI-Enabled Antarctic Sea-Ice, Iceberg Trajectory, and Navigation Decision Support System (SIH26059)
...
## 60. Digital Platform for efficient remote management of Indian Antarctic Research Stations (SIH26060)
...
## 61. AI-Driven Smart Energy Management System for Polar Research Stations (SIH26061)
...
## 62. Integrated Polar Expedition Logistics and Asset Management System (SIH26062)
...
## 63. Integrated Polar Science Outreach, Knowledge Repository and Media Dissemination Portal (SIH26063)
...
## 66. OceanEmbed - Satellite Embedding-Based Deep Learning Framework for Reconstruction of Subsurface Ocean Temperature from Surface Satellite Observations. (SIH26066)
...
## 67. Develop a web-based interactive 3D visualization platform that integrates numerical ocean model outputs and in-situ observations. (SIH26067)
...
## 68. WeatherGPT: Conversational AI for Weather Forecasting, Alerts, and Climate Information (SIH26068)
...
## 69. National Weather Big Data Analytics Platform (SIH26069)
...
## 70. To develop an Artificial Intelligence (AI) / Machine Learning (ML) based system for identification, classification, and prediction of different tropical cyclone patterns using multi-source satellite data. (SIH26070)
...
## 71. AI/ML-Based Integrated heavy rainfall Early Warning and Inundation Prediction System using Satellite, Radar, observational Weather and numerical weather prediction model data. (SIH26071)
...
## 72. AIML based Nowcasting of thunderstorm and lightning using atmospheric observation including multiple radars, satellite, lightning and model data. (SIH26072)
...
## 73. AI/ML-Based Intelligent Anomaly Detection for Automatic Weather Stations (AWS) (SIH26073)
...
## 74. Downscaling of weather forecast from Block level to Panchayat level: Inferring high-resolution plots/ data/ information from low-resolution plot /data /information /variables for agro-meteorological advisory services. (SIH26074)
...
## 75. Participants are invited to design and develop **CAPACITY CONNECT A Digital Capacity Building and Learning Management Portal** to support organizational training, competency development, and knowledge sharing through a centralized web-based platform. (SIH26075)
...
## 76. Development of personalized homepage for 'Mausam' mobile application: (SIH26076)
...
## 77. AI-Driven Hyper-Local Early Warning System for Severe Weather Nowcasting (SIH26077)
...
## 78. AI-Driven Spatio-Temporal Tracking of Extreme Weather Anomalies in Medium-Range Forecasts (SIH26078)
...
## 79. AI-Based Forecast Bust Detection for Medium-Range Weather Forecasts (SIH26079)
...
## 80. Regime-Aware AI Post-Processing of Monsoon Rainfall Forecasts (SIH26080)
...
## 81. Hybrid AINWP Multi-Model Forecast Blending System (SIH26081)
...
## 82. Air PollutionWeather Coupled Forecasting System (Delhi NCR Focus) (SIH26082)
...
## 83. Extreme Heatwave Early Warning and Human Thermal Stress Index (SIH26083)
...
## 84. Convective scale nowcasting for Thunderstorms, Hail & Cloudbursts (06 hr) (SIH26084)
...
## 85. Urban Flood Nowcasting System (Drainage and Rainfall Coupling) (SIH26085)
...
## 86. Hyperlocal Monsoon Onset & Break Prediction System (Block/Village Scale) (SIH26086)
...
## 89. Cooperative Gig Services Platform for Household & Community Services (SIH26089)
...
## 90. AI-Driven Market Linkage and Smart Cataloging Mobile Application for Marginalized Artisans (SIH26090)
...
## 91. AI-Driven Hyper-Local Business Advisory and Financial Structuring Assistant for Rural Micro-Entrepreneurs (SIH26091)
...
## 92. AI-Driven Scheme Matching for Marginalized Entrepreneurs (SIH26092)
...
## 93. AI-Based Real-Time Stress and Trauma Assessment Module for Victims/Complainants Accessing NHAA (14566) and Integrated Portal (SIH26093)
...
## 94. AI-Powered Dynamic Mental Health Monitoring and Distress Prediction System for Victims of Atrocities (SIH26094)
...
## 95. Smart Real-Time Monitoring & Inspection Mobile App (SIH26095)
...
## 97. AI-Driven voice Assistant for livelihood Mapping and NSQF-Aligned Skilling Recommendations for SC Communities under GIA component of PM-AJAY (SIH26097)
...
## 99. AI-Driven Standardization and Harmonization of Material Codes Across CPSEs (SIH26099)
...
## 100. AI-Powered Integrated Bid Compliance Verification Platform for GeM Procurement (SIH26100)
...
## 101. Develop an AI enabled learning platform that identifies competency gaps, recommends personalized training through integration with the iGOT Karmayogi ecosystem, and capable of generating Quizzes and Multiple choice questions (MCQs) from uploaded learning materials to strengthen capacity building in India's Official Statistical System. (SIH26101)
...
## 102. Development of an AI-powered system to detect anomalies, fraud, and inefficiencies in MPLAD Scheme implementation regd. (SIH26102)

- **Organization:** MoSPI
- **Theme:** Miscellaneous
- **Deadline:** 2026-09-20
- **Ideas submitted:** 0/500
- **Dataset link:** https://mplads.mospi.gov.in/digigov/dashboard.html
...
## 103. Use case on web-based integrated project-monitoring platform (SIH26103)
...
## 104. AI-Powered Real-Time Detection and Prevention of Voice Cloning Impersonation Attacks (SIH26104)
...
## 105. AI-Powered Continuous Cyber Risk Quantification and Investment Optimization Platform (SIH26105)
...
## 106. AI-Powered Email Threat Detection, GeoLocation and Forensic Intelligence Platform (SIH26106)
...
## 107. Al-powered Intelligent Assistant for Indian Standards and BIS Services for Industries and Consumers (SIH26107)
...
## 108. AI-Powered Recommendation Engine for Identifying Applicable Indian Standards for Procurement Specifications (SIH26108)
...
## 111. Smart Al-Enabled Rapid Feed and Silage Quality Testing System for Dairy Farmers (SIH26111)
...
## 114. Smart City Site Planning using Autodesk Forma Site Design (SIH26114)
...
## 115. Design and Develop a Smart Mobile Medical-Waste Collection and Segregation System (SIH26115)
...
## 117. Sovereign On-Premise Agentic AI Workbench using Open-Weight Multimodal LLMs for Confidential Industrial Work (SIH26117)
...
## 119. Indigenous GPU-Accelerated Optimization Solver (Sovereign Alternative to Express / CEPLEX) (SIH26119)
...
## 120. Digital Twin for Well-to-Surface Optimization of Cyclic Steam Stimulation (CSS) and Sucker Rod Pump (SRP) Operations for Heavy Oil Wells of Baghewala Field. (SIH26120)
...
## 121. eRTMAC-NWIS (Nearby Wells Intelligence System): An AI-Powered Offset Well Knowledge and Decision Support Platform for Drilling Operations (SIH26121)
...
## 122. Intelligent Data Capture & Schedule-Linking Layer for Infrastructure Project Management: Real-Time Actual Progress Tracking (Planning-to-Execution Bridge) (SIH26122)
...
## 123. Edge-AI Based Distributed Fleet Coordination for Autonomous Mobile Robots (AMRs) in Smart Warehouses (SIH26123)
...
## 124. AI-Powered Mobile Urban Intelligence Platform Using Public Transport Fleet (SIH26124)
...
## 125. Blockchain-Based Secure Platform for Identity,Access Control, and Digital Asset Management (SIH26125)
...
## 126. Vision Based Autonomous Navigation for Unmanned Ground Vehicle for Outdoor environment (SIH26126)
...
## 127. City-Wide AI Engine for Multi-Camera ANPR Trajectory Tracking and Urban Traffic Analytics (SIH26127)
...
## 128. Efficient systems for early detection,prevention,and management of livestock diseases and animal health issues (SIH26128)
...
## 129. System integration and interoperability among government digital platforms,resulting in fragmented service delivery (SIH26129)
...
## 130. Efficiency in streamlining industrial approvals,compliance processes,and access to government support services (SIH26130)
...
## 131. Early detection and management of crop diseases and pest infestations (SIH26131)
...
## 132. Strengthening market linkages and price discovery for farmers (SIH26132)
...
## 133. Accessibility and quality of public healthcare services,particularly in rural and underserved areas (SIH26133)
...
## 134. Challenges in aligning skill development programs with industry requirements and emerging job market demands (SIH26134)
...
## 135. Difficulties in tracking employment outcomes,skill gaps, and the impact of skilling initiatives (SIH26135)
...
## 136. Startup friendly public procurement mechanism that enables government departments to identify,pilot, procure,and scale innovative solutions from eligible startups (SIH26136)
...
## 137. Quantum-Inspired Intelligent Traffic Route Optimization in Transportation Systems Using Metaheuristic Optimization (SIH26137)
...
## 138. Quantum-Inspired Fuel Consumption Prediction and Green Fleet Optimization (SIH26138)
...
## 139. Hybrid Quantum Machine Learning Platform for Early Disease Detection (SIH26139)
...
## 140. AI-Based Interactive Quantum Algorithm Learning Platform (SIH26140)
...
## 141. Quantum-Inspired Cyber Threat Detection for Digital Signature Security (SIH26141)
...
## 142. Deep Learning Based Super Resolution Mapping (SRM) from Medium Resolution Satellite Imageries (SIH26142)
...
## 143. Leveraging satellite imagery to determine Oil spills at sea along with AIS data correlations to identify vessel responsible for the spill. (SIH26143)
...
## 145. AI-Based Detection of Cyber Threats in Unidirectional IP Traffic (SIH26145)
...
## 146. AI-Powered Monitoring & Analysis of Bitcoin Transaction Traffic (SIH26146)
...
## 147. Automated model for analysis of .IQ and .wav files along with signal parameter extraction (SIH26147)
...
## 148. Creation of scripts/functions with new programming language to commence Computer & Network forensic analysis without triggering security solutions (SIH26148)
...
## 149. Design and Development of an Integrated Secure Data Erasure and Advanced File Recovery Tool for Digital Forensics and Data Sanitization (SIH26149)
...
## 150. Development of a Multi-Vendor DVR/NVR Forensic Analysis Tool for Standardized Acquisition, Recovery, and Analysis of Surveillance Evidence. (SIH26150)
...
## 151. Dark web threat actor de-anonymization (SIH26151)
...
## 152. Social Media Analytics (SIH26152)
...
## 153. AI based Network Attack Forecasting from Network Traffic Data (SIH26153)
...
## 154. Gen AI Platform for Automated Content Transformation (SIH26154)
...
## 155. AI-Driven Multi-Vendor Network Security Compliance Auditor (SIH26155)

- **Organization:** National Technical Research Organisation (NTRO)
- **Theme:** Blockchain & Cybersecurity
- **Deadline:** 2026-09-20
- **Ideas submitted:** 0/500
- **Dataset link:** &#8226; Check nciipc.gov.in , helpdesk1@nciipc.gov.in<br> &#8226; CIS Benchmarks, NIST SP 800-53, DISA STIGs, ISO/IEC 27001; Vendor-specific CLI configuration samples.<br>
...
## 156. Universal Log Pre-processing Framework (SIH26156)
...
## 157. Supervisory Analytics Tool for SOC Assessment (SAT-SA) (SIH26157)
...
## 158. Single-Pass Drone Video to Accurate 3D Model Generation System (SIH26158)
...
## 159. SecureMailScope: AI-Assisted Cryptographic Security Posture Assessment for Secure Email Communications (SIH26159)
...
## 160. AI-Powered IPsec VPN Protocol Analyzer and Security Assessment Framework (SIH26160)
...
## 161. Dam Break Inundation Modelling Using Hydrodynamic Modelling of any River (SIH26161)
...
## 162. AI-Based Detection and Classification of Industrial Fires and Persistent Thermal Sources Using NASA FIRMS, OSM & Satellite Data (SIH26162)
...
## 163. Security Assessment of the World Monitor application (SIH26163)
...
## 164. Enterprise Cryptographic Discovery & Analysis Tool (ECDAT) (SIH26164)
...
## 165. AI/NLP Engine to Detect Serious Injury & Fatality (SIF) Precursors in OIL's Unsafe-Act/Unsafe-Condition and Near-Miss Reports (SIH26165)
...
## 166. Multi-modal, Sun angle and scale invariant image correspondence using Chandrayaan-2 optical images (OHRC, TMC and IIRS) (SIH26166)
...
## 167. SatQuery AI - An Interactive Vision-Language Assistant for Multimodal Remote Sensing Image Analysis through Text Queries (SIH26167)
...
## 168. AI-ML based Intelligent Dead Reckoning system for seamless navigation (SIH26168)

- **Organization:** Indian Space Research Organisation(ISRO)
- **Theme:** Miscellaneous
- **Deadline:** 2026-09-20
- **Ideas submitted:** 0/500
- **Dataset link:** IO-VNBD: Inertial and Odometry benchmark dataset for ground vehicle positioning (https://github.com/onyekpeu/IO-VNBD)
...
## 169. Development of an AI-Based Virtual Camera Tracking System for Coarse Alignment of Mobile Free Space Optical Communication (FSOC) Terminals (SIH26169)
...
## 170. AI-Driven Anomaly Detection in Component Burn-In & Screening (SIH26170)
...
## 171. On-device Visual Perception for Light-weight Browser Agents (SIH26171)

- **Organization:** Indian Space Research Organisation(ISRO)
- **Theme:** Miscellaneous
- **Deadline:** 2026-09-20
- **Ideas submitted:** 0/500
- **Dataset link:** Any open-source data can be used. Use cases for evaluation will provided during finale
...
## 173. iTantra -Indian Multilingual TTS & STT Aided Neural Transceiver Radio Access for low bitrate links (SIH26173)
...
## 174. AI Human Activity Recognition for On-board BAS Experiments (SIH26174)
...
## 175. DepthWizard - Single-View Height Estimation and 3D Flythrough (SIH26175)
...
## 176. ORCA Marine EcOsystem Reasoning with Collaborative Agents (SIH26176)
...
## 182. Automated Attribution of Unknown Cryptocurrency Wallets to Nearest Virtual Asset Service Providers (VASPs) through Blockchain Intelligence APIs (SIH26182)
...
## 183. Real-Time Identification of Fraud-Linked Cryptocurrency Exchanges from Victim-Reported Suspect Wallet Addresses through Automated Blockchain Analytics (SIH26183)
...
## 184. Development of a Predictive Analytics Framework for Cybercrime Complaints to Forecast Likely Cash Withdrawal Locations in Advance, Enabling Generation of Actionable Intelligence for Timely and Proactive Cybercrime Intervention. (SIH26184)
...
## 186. AI-Based Predictive Personnel Stress and Welfare Monitoring System for Uniformed Forces (SIH26186)
...
## 187. AI-Based Intelligent Video Analytics Platform for Border Surveillance using existing CCTV Infrastructure. (SIH26187)
...
## 188. Al-Based Fake Identity & Document Screening System (SIH26188)
...
## 189. AI-Powered Criminal Network Analysis System (SIH26189)
...
## 190. Secure Digital Document Management System for Legal and Investigation Documents (SIH26190)
...
## 191. Intelligent Identification of Hazard-Based Red Zones, Carrying Capacity Assessment, and Immediate Relocation Needs for Vulnerable Habitations (SIH26191)
...
## 192. Flash Flood Prediction System for Hilly Regions using Multi-Source Data Theme (SIH26192)
...
## 193. Student Innovation (SIH26193)
...
## 194. Student Innovation (SIH26194)
...
## 195. Student Innovation (SIH26195)
...
## 196. Student Innovation (SIH26196)
...
## 197. Student Innovation (SIH26197)
...
## 198. Student Innovation (SIH26198)
...
## 199. Student Innovation (SIH26199)
...
## 200. Student Innovation (SIH26200)
...
## 201. Student Innovation (SIH26201)
...
## 202. Student Innovation (SIH26202)
...
## 203. Student Innovation (SIH26203)
...
## 204. Student Innovation (SIH26204)
...
## 205. Student Innovation (SIH26205)
...
## 206. Student Innovation (SIH26206)
...
## 207. Student Innovation (SIH26207)
...
## 208. Student Innovation (SIH26208)
...
## 209. Student Innovation (SIH26209)
